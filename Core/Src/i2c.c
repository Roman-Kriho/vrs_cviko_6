...
void i2c_master_write(uint8_t slave_addr,  uint8_t register_addr, uint8_t data, uint8_t length)
{
	if(length)
		{
			register_addr |= (1 << 7);
...
uint8_t* i2c_master_read(uint8_t slave_addr,uint8_t register_addr, uint8_t* buffer, uint8_t length)
{
